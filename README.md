...
### Verification
From the workflow step `Deploy Cloud Run` copy out url `https://lykia-app-__________run.app` of the invoke endpoint:
```
Invoke endpoint:
https://lykia-app-__________run.app
```

Call the api endpoint:
```
curl https://lykia-app-__________run.app/lykiaApp
```
